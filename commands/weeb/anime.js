    ...
    const kitsu = new Kitsu();
            ...
            if (!search) {
              ...
              kitsu.searchAnime(search).then(result => {
                  ...
                  embed
                      .setColor('#FF9D6E')
                      .setAuthor(`${anime.titles.english || anime.titles.romaji || search} | ${anime.showType}`, anime.posterImage.original)
                      ...
                      .addField('❯\u2000\ ' + bot.lang.get(bot.language, "jp", "status"), `•\u2000\**${bot.lang.get(bot.language, "jp", "episodeCount")}:** ${anime.episodeCount ? anime.episodeCount : 'N/A'}\n\•\u2000\**${bot.lang.get(bot.language, "jp", "startDate")}:** ${anime.startDate}\n\•\u2000\**${bot.lang.get(bot.language, "jp", "endDate")}:** ${anime.endDate ? anime.endDate : `${bot.lang.get(bot.language, "jp", "stillAiring")}`}`, true)
